...
- **Товарные строки живут около пяти лет.** У 106 чеков 2018–2020 годов их уже нет: ФНС отвечает «сервис
  ...
  если понадобится).
- **Квартира лежит в тех же чеках.** Апрель 2025: три чека застройщика на 34 086 000 + 28 086 000 +
  6 000 000 ₽ и мебель с техникой ещё на 2,5 млн — это 99% всей суммы за восемь лет. Любая статистика,
  которая их не отделяет, превращается в одну палку в апреле 2025.
