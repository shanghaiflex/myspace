...
показанного лежит в `UserDefaults`; самый первый запуск только запоминает — иначе после переустановки
телефон зазвонил бы о вчерашнем). Apple Watch зеркалят уведомление телефона сами, пока он заперт, так что
