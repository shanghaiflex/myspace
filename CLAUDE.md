...
(температуры Hue, яркость × 0,76 — цифры Hue один к одному на Tuya светят ярче, чем задумано), «Кино» — 8 %,
6500 K, как bias lighting для телевизора (дневной белый, рядом с тёплым светом кажется чуть голубым). Приглушённо/Отдых/Ярко/Собраться/Ко сну удалены 14.09.2026 по просьбе; цветные пресеты в духе WiZ (янтарь,
