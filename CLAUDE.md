...
подписи свободные окна дня, а когда на сегодня ничего не осталось — во сколько начинается завтра. Пустой день —
«день свободен». Календарь недоступен — плашки просто нет.
