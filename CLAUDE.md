...
`lamp` из скилла. Сцены только белые: «Уютно» пользователя (43 %, 2300 K) плюс рецепты Philips Hue с их
родными цифрами (Rest, Dimmed, Read, Bright, Concentrate, Nightlight); цветные пресеты в духе WiZ (янтарь,
